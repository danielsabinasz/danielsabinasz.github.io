...
$( function() {
    ...
    $("select[name=perspective]").change(function() {
        brain3d.setPerspective(this.value);
        $("#rotate").attr("checked", false);
	brain3d.setAutoRotate(false);
    });
    ...
    console.log("before");
    $("select[name=perspective]").val("");
    $("select[name=section]").val("wholebrain");
    console.log("after");
});
